...
import { StyleSheet, Text, View, Image, KeyboardAvoidingView, CheckBox, Dimensions, TouchableOpacity, TextInput, Alert, Picker } from 'react-native';
                        ...
                        <View style={{ marginTop: wp('0%'), alignContent: 'center', alignItems: 'center' }}>
                            ...
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('#')}>
                                <LinearGradient
                                    ...
                                    style={{ marginVertical: 8., marginTop: 20, alignSelf: 'center', borderWidth: 2, borderColor: '#00CC33', height: 60, width: 280, borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}
                                >
                                    <Text
                                        style={{
