...
import { Dimensions, StyleSheet, ImageBackground, View, Text, ActivityIndicator } from 'react-native';
...
export default class slider extends React.Component {
  ...
  _renderDoneButton = () => {
    return (
      <Button style={{ backgroundColor: '#2145FE', width: 200, marginRight: 60, marginTop: 0, borderRadius: 25 }}>
...
const slides = [
  ...
  },
  {
    ...
    text2: 'an appointment to a specific Salon or',
    text3: 'Hairdresser you want',
    image: require('./../image/GetStarted3.png'),
